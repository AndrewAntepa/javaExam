...
public class ExaminerServiceImpl implements ExaminerService {
    private final GenerateQuestionService generateQuestion;

    public ExaminerServiceImpl(GenerateQuestionService generateQuestion) {
        this.generateQuestion = generateQuestion;
    }

    @Override
    public Collection<Question> getJavaQuestions(int amount) {
        return generateQuestion.generateJavaQuestions(amount);
    }

    @Override
    public Collection<Question> getMathQuestions(int amount) {
        return generateQuestion.generateMathQuestions(amount);
    }
